    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-5">
            <div class="container">
                ...
                <h2 class="mb-4">McFaddan Order Details</h2>
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <?php if (!empty($orderDetails)): foreach ($orderDetails as $orderDetail): ?>
                        <tr>
                        ...
                        <tr> <td colspan = "3"> No Order details for this order :) </td> </tr>
                    <?php endif; ?>
                    </tbody>
                </table>
